...
public class ShotDistTest {
    ...
    public void isShotScoreCorrect() throws Exception {
        ...
        assertEquals(-1, setup.getShot3().getShotScore(), 0.01);
        assertEquals(0.22, setup.getShot4().getShotScore(), 0.01);
        assertEquals(-0.16, setup.getShot5().getShotScore(), 0.01);
